 ...
 * @author chemo
 */
public class VtnMostrarPagosRealizados extends javax.swing.JFrame
{

    public VtnMostrarPagosRealizados()
    {
        initComponents();
    ...
    private void initComponents()
    {
        ...
        jPanel1.add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 107, 1000, 10));

        tablaPagos.setFont(new java.awt.Font("Century Gothic", 0, 14)); // NOI18N
        tablaPagos.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String []
            {
                "Referencia", "Titular", "Tarjeta", "Mes", "Año", "CVV", "Fecha Pago"
            }
        )
        {
    ...
    {//GEN-HEADEREND:event_formWindowOpened
        try
        {
            muestraPagos(VtnIncio_Secion.pagoRealizado);
        } catch (Exception e)
        {
    ...
    private void muestraPagos(PagoRealizado[][] pagos)
    {
            ...
            if (pagos[i] != null && pagos[i].length > 0)
            {
                for (int j = 0; j < pagos[i].length; j++)
                {
                    if (pagos[i][j] != null)
                    {
                        ...
                        Object[] row =
                        {
                            pagos[i][j].getNumeroReferencia(),
                            pagos[i][j].getTitular(),
                            pagos[i][j].getNumTarjeta(),
                            pagos[i][j].getMes(),
                            pagos[i][j].getAnio(),
                            pagos[i][j].getCvv(),
                            fechaFormateada
    ...
    public static void main(String args[])
    {
        ...
        {
            java.util.logging.Logger.getLogger(VtnMostrarPagosRealizados.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
